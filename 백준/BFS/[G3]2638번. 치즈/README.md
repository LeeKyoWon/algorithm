...
- 치즈 내부의 공간과 치즈 외부의 공기는 둘 다 값은 0 이지만 의미상 차이가 존재하므로 분리해야 한다.

	1. 치즈 내부의 공간은 치즈를 녹이는 데 영향 X

	2. 치즈 외부의 공기는 치즈를 녹이는 역할
  
- 분리 방법 : 맨 가장자리는 치즈가 놓이지 않으므로 (0, 0)으로부터 bfs를 수행해서 연결되지 않는 0은 치즈 내부의 공간

---

### 성능 요약

메모리: 31312 KB, 시간: 224 ms
