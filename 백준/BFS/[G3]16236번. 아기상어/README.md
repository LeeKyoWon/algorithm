...
- BFS 를 적용하면서, 우선순위를 적용하고 싶다

- 우선순위

  1. 최단 거리가 같은 경우에 가장 위쪽의 물고기

  2. 최단 거리가 같으면서 높이도 같다면 가장 왼쪽의 물고기

- __아이디어__
  - 우선 순위를 적용하기 위해 LinkedList가 아닌 PriorityQueue 로 구현한다. 
...
<p>아기 상어가 어디로 이동할지 결정하는 방법은 아래와 같다.
...
<p>첫째 줄에 공간의 크기 N(2 ≤ N ≤ 20)이 주어진다.
