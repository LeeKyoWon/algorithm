...
-  결국 매번 왼발 또는 오른발 중 하나를 움직인다

	- 왼발, 오른발을 적절한 순서대로 움직여서 최솟값을 찾아내야 한다 (모든 경우의 수를 찾아내야 한다)

	- DP 를 사용해서 모든 오른발, 왼발 경우의 수에 대해 찾아서 최종적으로 최소를 찾아야겠다.

---

### 성능 요약

메모리: 48604 KB, 시간: 380 ms
...
- 그리고 0은 수열의 마지막을 의미한다. 즉, 입력 파일의 마지막에는 0이 입력된다. 
